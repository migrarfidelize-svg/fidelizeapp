...
import { Shield, LayoutDashboard, Building2, CreditCard, ArrowLeft, Bell, FileClock, UsersRound, Settings, Mail } from "lucide-react";
...
function AdminLayout() {
  ...
  const nav = [
    ...
    { to: "/admin/emails", label: "E-mail", icon: Mail, exact: false },
