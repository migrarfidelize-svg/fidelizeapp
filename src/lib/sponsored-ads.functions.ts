...
const upsertSchema = z.object({
  ...
  display_model: z.enum(["premium_banner", "sponsored_feed", "carousel"]).default("sponsored_feed"),
  
  // Visual fields
  offer_type: z.enum(["discount", "percentage", "savings", "benefit", "loyalty", "reward"]).default("benefit"),
  ...
  theme: z.enum(["premium_dark", "premium_light", "gradient_promo", "editorial", "minimal_product", "seasonal"]).default("premium_dark"),
